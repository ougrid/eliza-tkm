...
var FarcasterPostManager = class {
  ...
  async generateNewCast() {
    elizaLogger2.info("Generating new cast");
    try {
      ...
      try {
        ...
        elizaLogger2.error("Error sending cast:", error);
      }
    } catch (error) {
      elizaLogger2.error("Error generating new cast:", error);
    }
  }
};
...
var FarcasterAgentClient = class {
  constructor(runtime, client) {
    ...
    elizaLogger3.info("Farcaster Neynar client initialized.");
