...
// src/environment.ts
var buttplugEnvSchema = z.object({
...
async function validateButtplugConfig(runtime) {
  try {
    const config = {
  ...
  if (intifaceProcess) {
    ...
    try {
      ...
      if (intifaceProcess.killed === false) {
        try {
          const killCommand = process.platform === "win32" ? spawn("taskkill", [
            "/F",
            "/IM",
            "intiface-engine.exe"
...
// src/index.ts
var ButtplugService = class extends Service {
  static serviceType = ServiceType.BUTTPLUG;
  client;
  connected = false;
...
var src_default = buttplugPlugin;
export {
  ButtplugService,
  buttplugPlugin,
